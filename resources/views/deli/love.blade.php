  ...
  <script>
    ...
    (function (window, document, undefined) {
      ...
      var imageAssets = {
          ...
          dogeSmall: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/188512/doge-small.png"
        },
        imageAssetsArray = [],
        i;
      ...
      HeartParticle.prototype.position = function (cx, cy) {
        ...
        this.oy = this.y = cy + 11 * (-(15 * Math.cos(this.i) - 5 * Math.cos(2 * this.i) - 2 * Math.cos(3 * this.i) -
          Math.cos(4 * this.i)));
      };
      ...
      window.addEventListener('load', function () {
        ...
        loadAllImages(function (loadedAssets, errorMessage) {
          if (typeof errorMessage !== "string") {
            ...
            p.push(new DogeText(cx, cy, "te amo", 45, 50, -100, new RGB(255, 0, 255)));
            p.push(new DogeText(cx, cy, "te quiero", -55, -220, -110, new RGB(255, 255, 0)));
            p.push(new DogeText(cx, cy, "te adoro", 55, 160, -160, new RGB(0, 255, 0)));
            p.push(new DogeText(cx, cy, "Eli hope"-12, 260, -20, new RGB(0, 100, 255)));
            p.push(new DogeText(cx, cy, "princesa", 50, -180, 110, new RGB(255, 100, 0)));
            p.push(new DogeText(cx, cy, "Feaaaaaaaaaaaaaa", -50, 140, 140, new RGB(0, 255, 100)));
